...
def assess_release(r: dict) -> dict:
    ...
    # Upcoming or missing actual -> pending.
    if status == "upcoming" or actual is None:
        out["verdict"] = "Pending"
        out["verdict_note"] = "Not yet released"
        return out
...
def assess_releases(releases: list[dict], house_view: dict | None = None) -> dict:
    """
    ...
    """
    scored = [assess_release(r) for r in releases]
